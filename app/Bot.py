...
class Bot:
    ...
    def send_seen(self,recipient_id):
        data={'recipient':{'id': recipient_id},'sender_action' : 'mark_seen'}
        return self.send_raw(data)
    
    def send_message_option(self,recipient_id,message,options):
        data={
        'recipient':{
        'id':recipient_id
        },
        ...
        return self.send_raw(data)
    def send_message_graphe(self,recipient_id):
        data={
        'recipient':{
        'id':recipient_id
        },
        ...
        return self.send_raw(data)
    def send_message_graph(self,recipient_id):
        data={   
